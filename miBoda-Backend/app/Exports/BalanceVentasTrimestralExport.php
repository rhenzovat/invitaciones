...
class BalanceVentasTrimestralExport implements FromCollection, WithHeadings, WithStyles, WithEvents
{
    protected $datos;
    protected $resumen;
    protected $anio;
    ...
    public function __construct($datos, $resumen, $anio, $trimestre)
    {
        $this->datos = $datos;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'REPORTE TRIMESTRAL DE BALANCE DE VENTAS');
                $sheet->setCellValue('A2', 'Año: ' . $this->anio . ' - Trimestre: ' . $this->trimestre);
