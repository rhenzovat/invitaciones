...
return [
  ...
  'enabled' => [
    ...
    */
    ...
    'directives' => [
        '@' => 'x-on:', // Esto protege Alpine.js si lo usas
    ],
 ...
 'keep_directives' => [
        '@vite', // Esto protege la línea de Vite
    ],

     // AGREGA ESTA NUEVA SECCIÓN:
  // AGREGAR o MODIFICAR esta sección:
    'options' => [
        'html' => [
            'encode_php' => false,    // Importante: no codificar PHP
            'encode_entities' => false, // Importante: no convertir entidades HTML
            'keep_document_html_tags' => true,
        ],
    ],
