...
<head>
    ...
    <title>Recuperar Contraseña - royalsensorymassage</title>
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="hero">
                <img src="{{ config('app.url') }}/imagenes/lucdesoft01.svg" alt="Recuperar Contraseña">
            </div>

            <div class="content">
                <h1>¿Olvidaste tu contraseña?</h1>
                <p>Hola,</p>
                <p>Estás recibiendo este correo porque solicitaste restablecer tu contraseña para tu cuenta de royalsensorymassage.</p>
                <p>Para crear una nueva contraseña, haz clic en el botón de abajo:</p>

                <div style="text-align: center;">
                    <a href="{{ route('reset.password.get', $token) }}" class="button">RESTABLECER CONTRASEÑA →</a>
                </div>

                <p style="margin-top: 30px; font-size: 14px; color: #666;">Si no realizaste esta solicitud, puedes ignorar este correo de forma segura. Tu contraseña actual no cambiará hasta que accedas al enlace y registres una nueva.</p>
            </div>
