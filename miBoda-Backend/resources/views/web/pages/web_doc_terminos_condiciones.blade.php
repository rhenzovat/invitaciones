...
<head>
  ...
  <title>@yield('title', $metaData->titulo_pagina ?? 'Términos y Condiciones | royalsensorymassage')</title>
  <meta name="description" content="{{ $metaData->descripcion_pagina ?? 'Términos y condiciones del servicio de royalsensorymassage — empresa de servicios tecnológicos en Lima, Perú.' }}">
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ── HERO ── */
    .ld-hero {
      background: linear-gradient(135deg, #0f172a 0%, #1a2f4a 50%, #0f2d1e 100%);
    ...
    .ld-toc__header p { font-size: .70rem; font-weight: 700; color: #6ee7b7; text-transform: uppercase; letter-spacing: .1em; }
    ...
    .ld-toc__item a:hover { color: #059669; background: #ecfdf5; border-left-color: #10b981; }
    ...
    .ld-back:hover { color: #059669; border-color: #a7f3d0; }
    ...
    .ld-content h3 {
      font-size: .95rem; font-weight: 700; color: #065f46;
    ...
    .ld-content a { color: #059669; font-weight: 500; }
    ...
    .ld-chip {
      ...
      color: #065f46; font-size: .73rem; font-weight: 600;
    ...
    .ld-contact-box h4 { font-size: .88rem; font-weight: 700; color: #065f46; margin-bottom: 12px; }
    .ld-contact-box a {
      display: inline-flex; align-items: center; gap: 6px;
      color: #059669; font-size: .85rem; font-weight: 500; text-decoration: none;
    ...
    .ld-footer__link:hover { color: #6ee7b7; }
...
<section class="ld-hero">
  <div class="ld-hero__badge">📋 Legal &amp; Condiciones</div>
  <h1 class="ld-hero__title">Términos y Condiciones</h1>
  <p class="ld-hero__sub">Condiciones de uso y contratación de los servicios tecnológicos de royalsensorymassage.</p>
  <div class="ld-hero__meta">
    <span>📅 Última actualización: <strong>Mayo 2026</strong></span>
    <span>⚖️ Derecho Peruano</span>
  </div>
</section>
  ...
  <aside class="ld-sidebar">
    <div class="ld-toc">
      ...
      <ul class="ld-toc__list" style="list-style:none">
        <li class="ld-toc__item"><a href="#s1">1. Aceptación</a></li>
        <li class="ld-toc__item"><a href="#s2">2. Descripción del servicio</a></li>
        <li class="ld-toc__item"><a href="#s3">3. Usuarios y cuentas</a></li>
        <li class="ld-toc__item"><a href="#s4">4. Cotizaciones y precios</a></li>
        <li class="ld-toc__item"><a href="#s5">5. Pago y facturación</a></li>
        <li class="ld-toc__item"><a href="#s6">6. Propiedad intelectual</a></li>
        <li class="ld-toc__item"><a href="#s7">7. Obligaciones del cliente</a></li>
        <li class="ld-toc__item"><a href="#s8">8. Limitación de responsabilidad</a></li>
        <li class="ld-toc__item"><a href="#s9">9. Privacidad y datos</a></li>
        <li class="ld-toc__item"><a href="#s10">10. Modificaciones</a></li>
        <li class="ld-toc__item"><a href="#s11">11. Suspensión y cancelación</a></li>
        <li class="ld-toc__item"><a href="#s12">12. Ley aplicable</a></li>
        <li class="ld-toc__item"><a href="#s13">13. Resolución de disputas</a></li>
        <li class="ld-toc__item"><a href="#s14">14. Disposiciones generales</a></li>
        <li class="ld-toc__item"><a href="#s15">15. Contacto</a></li>
      </ul>
    </div>
  ...
  <main>
    <div class="ld-card">
      ...
      <div class="ld-card__body">
        ...
        <div class="ld-chips">
          <span class="ld-chip">⚖️ Derecho Peruano</span>
          <span class="ld-chip">📋 15 Secciones</span>
          <span class="ld-chip">🔄 Servicio continuo</span>
          <span class="ld-chip">📅 Vigente Mayo 2026</span>
        </div>
        ...
        <div class="ld-contact-box">
          <h4>¿Tienes dudas sobre los términos del servicio?</h4>
    ...
    <div style="margin-top:16px;display:flex;gap:12px;flex-wrap:wrap">
      <a href="{{ url('/politica-privacidad') }}"
        ...
        <div>
          <p style="font-size:.80rem;font-weight:700;color:#0f172a">Política de Privacidad</p>
          <p style="font-size:.73rem;color:#64748b;margin-top:2px">Ver política de datos personales</p>
        </div>
        <span style="margin-left:auto;color:#94a3b8;font-size:.85rem">→</span>
      </a>
      <a href="{{ url('/cotizador') }}"
         style="flex:1;min-width:200px;background:#ecfdf5;border:1px solid #a7f3d0;border-radius:12px;padding:16px 20px;text-decoration:none;display:flex;align-items:center;gap:12px;transition:box-shadow .15s"
         onmouseover="this.style.boxShadow='0 4px 16px rgba(16,185,129,.15)'" onmouseout="this.style.boxShadow='none'">
        <span style="font-size:24px">🚀</span>
        <div>
          <p style="font-size:.80rem;font-weight:700;color:#065f46">Cotizar mi proyecto</p>
          <p style="font-size:.73rem;color:#10b981;margin-top:2px">Respuesta en menos de 24 h</p>
        </div>
        <span style="margin-left:auto;color:#10b981;font-size:.85rem">→</span>
      </a>
    </div>
  </main>
