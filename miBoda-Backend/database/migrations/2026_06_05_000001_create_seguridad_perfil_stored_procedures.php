...
SQL);
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS USP_SEGURIDAD_PERFIL_LISTAR');
        DB::unprepared(<<<'SQL'
...
SQL);
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS USP_SEGURIDAD_PERFIL_ASIGNAR');
        DB::unprepared(<<<'SQL'
...
SQL);
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS USP_SEGURIDAD_PERFIL_ELIMINAR_MULTIPLE');
        DB::unprepared(<<<'SQL'
...
SQL);
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS USP_SEGURIDAD_PERFIL_OBTENER_CHECK');
        DB::unprepared(<<<'SQL'
...
SQL);
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS USP_SEGURIDAD_PERFIL_OBTENER_ELIMINAR');
        DB::unprepared(<<<'SQL'
...
SQL);
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS USP_SEGURIDAD_PERFIL_OBTENER_LISTA');
        DB::unprepared(<<<'SQL'
