...
{
    private array $menus = [
        ['nombre' => 'Página Nosotros', 'url' => '/pagina-nosotros/index', 'Icon' => 'groups'],
        ['nombre' => 'Página Contacto', 'url' => '/pagina-contacto/index', 'Icon' => 'contact_mail'],
    ];
        ...
        if (Schema::hasTable('web_header') && DB::table('web_header')->exists()) {
            DB::table('web_header')->where('id_header', 1)->update([
                'nav_items' => json_encode([
                    ...
                    ['label' => 'Proyectos', 'href' => url('/#eventos'), 'children' => [
                        ['label' => 'Eventos', 'href' => url('/#eventos')],
                    ]],
                    ['label' => 'Publicaciones', 'href' => url('/publicaciones')],
                    ['label' => 'Contáctanos', 'href' => url('/contacto')],
                ], JSON_UNESCAPED_UNICODE),
                'btn_visitanos_url' => url('/contacto'),
                'btn_eventos_url'   => url('/#eventos'),
                'updated_at'        => now(),
            ]);
        }
