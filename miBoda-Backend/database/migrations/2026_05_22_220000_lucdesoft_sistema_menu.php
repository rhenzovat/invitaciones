...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $menus = [
            ['nombre' => 'Ejemplares', 'url' => '/ejemplares/index', 'Icon' => 'collections'],
            ['nombre' => 'Portafolio clientes', 'url' => '/portafolio/index', 'Icon' => 'work'],
        ];
    ...
    public function down(): void
    {
        ...
        foreach (['/ejemplares/index', '/portafolio/index'] as $url) {
