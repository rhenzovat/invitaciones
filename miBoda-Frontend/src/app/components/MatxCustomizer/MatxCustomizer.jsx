...
const demoLayouts = [
  {
    isPro: false,
    name: "Light Sidebar",
    thumbnail: `${import.meta.env.BASE_URL}assets/images/screenshots/layout1-customizer.png`,
    options: {
      activeTheme: "blue",
  ...
  },
  {
    ...
    thumbnail: `${import.meta.env.BASE_URL}assets/images/screenshots/layout5-customizer.png`,
    options: {
      activeTheme: "blue",
      activeLayout: "layout1",
      layout1Settings: {
  ...
  },
  {
    isPro: false,
    name: "Dark Sidebar",
    thumbnail: `${import.meta.env.BASE_URL}assets/images/screenshots/layout1-blue-customizer.png`,
    options: {
      activeTheme: "blue",
      activeLayout: "layout1",
      layout1Settings: {
