    ...
    <ChatContainer>
      <ProfileBox>
        <Box display="flex" alignItems="center">
          <ChatAvatar src={`${import.meta.env.BASE_URL}assets/images/face-2.jpg`} status="online" />
          <ChatStatus>
            <H5>Ryan Todd</H5>
            <Span>Active</Span>
          </ChatStatus>
      ...
      <StyledScrollBar id="chat-scroll">
        {messageList.map((item, ind) => (
          <Box
            ...
            <Box ml="12px">
              {currentUserId !== item.contactId && item.name && (
        ...
        <ChatImgContainer>
          <Box ml="12px">
            <ChatImgBox>
              <ChatImg alt="laptop" src={`${import.meta.env.BASE_URL}assets/images/laptop-1.png`} />
