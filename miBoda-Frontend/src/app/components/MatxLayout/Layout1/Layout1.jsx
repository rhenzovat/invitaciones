...
import TabbedOutlet from "app/components/TabbedOutlet/TabbedOutlet";
import { TabsProvider } from "app/contexts/TabsContext";
import { MenuFavoritosProvider } from "app/contexts/MenuFavoritosContext";
      ...
      <LayoutContainer width={sidenavWidth} open={secondarySidebar.open}>
        ...
        {settings.perfectScrollbar && (
          <StyledScrollBar>
            ...
            <Box flexGrow={1} position="relative" sx={{ minHeight: 0, display: "flex", flexDirection: "column" }}>
              <MatxSuspense>
                <TabbedOutlet />
              </MatxSuspense>
            </Box>
