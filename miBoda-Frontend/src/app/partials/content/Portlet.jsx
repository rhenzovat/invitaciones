...
export const PortletHeader = forwardRef(
  (
    { icon, title, toolbar, className, sticky = false, labelRef, titleDataGrid = false, ...props },
    ref
  ) => {
    ...
    return (<>
      {
        titleDataGrid && (typeof title === "string" || isFragment(title) ? (
      ...
      <div
        ref={ref}
        className={`${titleDataGrid ? 'kt-portlet__head' : 'kt-portlet__head_form'}`}
        style={
          !sticky
            ? undefined
