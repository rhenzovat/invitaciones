...
const PerfilesListPage = (props) => {
  ...
  const openModalRoles   = (evt) => props.seleccionarRoles(evt.row.data);
    ...
    <PageWrap>
      ...
      <Paper sx={{
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Stack direction="row" alignItems="center" spacing={1.5}>
            ...
            <Box>
              <Typography variant="h6" sx={{ color: "#fff", fontWeight: 700, lineHeight: 1.2 }}>
                {props.titulo || "Gestión de Perfiles"}
              </Typography>
              <Typography variant="caption" sx={{ color: "rgba(255,255,255,0.65)" }}>
                Administra los perfiles de usuario del sistema
              </Typography>
            </Box>
          </Stack>
          ...
          <Stack direction="row" alignItems="center" spacing={1.5}>
            ...
            />
            {accessButton.crear && (
              <Tooltip title="Nuevo perfil" placement="left">
                <IconButton
      ...
      <Paper sx={{
        ...
        >
          ...
          <SearchPanel visible={true} highlightCaseSensitive={true} placeholder="Buscar perfil…" />
          ...
          <Column
            ...
            width={100}
            alignment="center"
            visible={accessButton.agregar_rol ? true : false}
          >
            <ColumnButton icon="bulletlist" hint="Asignar Roles" onClick={openModalRoles} />
          </Column>
