...
const CategoriaPopularListPage = ({
  accessButton,
  titulo,
  ...
  const eliminarRegistro_ = (evt) => {
    const { id_categoria_popular } = evt.row.data;
    eliminarRegistro(id_categoria_popular, false);
  };
    ...
    return (
      <div style={{ position: 'relative', display: 'inline-block' }}>
        <img 
          ...
          onClick={() => handleOpenImageModal(imagenURL, e.data.nombre_categoria)}
          onMouseOver={(evt) => {
    ...
    <div className="container mt-3">
      ...
      <div className="row">
        ...
        >
          ...
          <Column dataField="id_categoria_popular" caption="ID" width={100} alignment="center" />
          <Column dataField="nombre_categoria" caption="Nombre Categoría" />
          <Column
...
export default CategoriaPopularListPage;